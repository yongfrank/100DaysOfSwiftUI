...
class CoreDataManager {
    static let coreDataManagerSharedClass = CoreDataManager()
    ...
    /// try? mocInAddFlagView.save() in other Core Data File
    func saveContext() {
    ...
    /// DrawingDocument is the Struct
    func addData(doc: DrawingDocument) {
        /// DrawingDoc is the entity
